export default function Auth({ img, title }) {
  return (
    <div className="bg-[#16082E] relative overflow-hidden mb-20">
      <div
      ...
      <div className="items-center lg:flex">
        <div className="h-full lg:w-1/2 ">
          <img
            ...
            alt="signup"
            className="mx-auto my-auto lg:ml-auto"
          />
        </div>
        <div className="text-white lg:w-1/2">
          <form className="w-1/2 mx-auto">
            ...
            <button type="submit" className="w-full mx-auto button ">
              Sign In
            </button>
